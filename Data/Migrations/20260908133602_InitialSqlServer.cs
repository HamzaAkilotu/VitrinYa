        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BoxContents = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Product_Price", "PriceCents > 0");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Cart_Quantity", "Quantity BETWEEN 1 AND 99");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StockTransactions_AspNetUsers_ActorId",
                        column: x => x.ActorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_SellerId_IsDeleted_Status",
                table: "Products",
                columns: new[] { "SellerId", "IsDeleted", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_Products_Status_IsDeleted_CategoryId_PriceCents",
                table: "Products",
                columns: new[] { "Status", "IsDeleted", "CategoryId", "PriceCents" });

            migrationBuilder.CreateIndex(
                name: "IX_Products_Status_IsDeleted_CreatedAt",
                table: "Products",
                columns: new[] { "Status", "IsDeleted", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_StockTransactions_ActorId",
